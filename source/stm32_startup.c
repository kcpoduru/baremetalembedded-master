...
void MemManage_Handler 				(void) __attribute__ ((weak/Users/ko106n4/Desktop/krishna/hobbie-study/fastBitEmbedded/baremetalembedded-master/source/stm32Linker.ld, alias("Default_Handler")));
...
void Reset_Handler(void)
{
  ...
  // init std library if you are using any printf scanf stuff
